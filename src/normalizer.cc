...
util::Status Normalizer::Normalize(absl::string_view input,
  ...
  if(!treat_whitespace_as_suffix_ && (add_dummy_prefix == normalizer::AddDummyPrefix::ON
     || (add_dummy_prefix != normalizer::AddDummyPrefix::OFF && spec_->add_dummy_prefix()))) add_ws();
